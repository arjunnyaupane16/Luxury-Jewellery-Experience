    ...
    >
      ...
      >
        <img
          ...
          alt="Polished gold ring profile"
      ...
      <div className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        >
          <p className="text-white/72 text-sm sm:text-base leading-relaxed tracking-[0.08em] font-light mb-6">
            The collection extends into bold black-gold finishes where polished surfaces alternate with satin
            textures. This contrast produces depth without sacrificing clarity in line and silhouette.
          </p>
          <p className="text-white/72 text-sm sm:text-base leading-relaxed tracking-[0.08em] font-light">
            A discreet mirror edge behind each setting introduces hidden reflections, revealing warm flashes
            of gold only when viewed in motion.
          </p>
        </div>
      </div>
    </section>
...
export default NoireLustreSection;
