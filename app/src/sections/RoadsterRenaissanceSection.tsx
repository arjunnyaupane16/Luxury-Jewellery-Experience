...
const RoadsterRenaissanceSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="/jewelry/hero-ring.jpg"
          alt="Gold ring on deep black surface"
      ...
      <div className="max-w-4xl mx-auto px-6 py-24 text-center">
        <div className="overflow-hidden mb-8">
          ...
          >
            THE RENAISSANCE OF SIGNATURE RINGS
          </h2>
        </div>
        ...
        >
          <p className="text-white/72 text-sm sm:text-base leading-relaxed tracking-[0.08em] font-light mb-6">
            Aurelia Maison reimagines the classic ring silhouette through sculpted galleries and elevated
            settings that allow each diamond to breathe in light. The result is a profile that feels both
            contemporary and heirloom in spirit.
          </p>
          <p className="text-white/72 text-sm sm:text-base leading-relaxed tracking-[0.08em] font-light">
            Clients may choose between pure solitaire compositions and halo expressions with graduated stones,
            each calibrated for balance, sparkle rhythm, and refined finger comfort.
          </p>
        </div>
      </div>
    </section>
...
export default RoadsterRenaissanceSection;
